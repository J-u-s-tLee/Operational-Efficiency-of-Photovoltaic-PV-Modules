...
from PreProcessedData import load_data, map_efficiency_level_to_numeric, split_data, preprocess_data
...
def main():
    ...
    X_train_processed, X_val_processed, X_test_processed = preprocess_data(X_train, X_val, X_test, params.categorical_cols)
    ...
    X_train_top_features_processed, X_val_top_features_processed, X_test_top_features_processed = preprocess_data(X_train_top_features, X_val_top_features, X_test_top_features, params.categorical_cols)
